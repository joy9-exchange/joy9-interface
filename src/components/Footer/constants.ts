...
export const FOOTER_LINKS: { home: Link[]; app: Link[] } = {
  ...
  app: [
    { text: defineMessage({ message: "Home" }), link: "https://joy9.io/", external: true },
    // { text: "Jobs", link: "/jobs" },
  ],
};
...
export const SOCIAL_LINKS: SocialLink[] = [
  { link: "https://twitter.com/joy9exchange", name: "Twitter", icon: twitterIcon },
  { link: "https://discord.gg/D6Rv7zrTVW", name: "Discord", icon: discordIcon },
  { link: "https://github.com/joy9-exchange", name: "Github", icon: githubIcon },
];
