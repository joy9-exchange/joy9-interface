      ...
      <div className="MarketStats-title">
        <div className="App-card-title-mark">
          <div className="App-card-title-mark-icon">
            <img className="MarketStats-gm-icon" src={getIcon(chainId, "gm")} alt="JLP" />
          </div>
          <div className="App-card-title-mark-info">
            <div className="App-card-title-mark-title">JLP{marketInfo && `: ${marketInfo.name}`}</div>
            <div className="App-card-title-mark-subtitle">Joy9 Market Tokens</div>
          </div>
        </div>
      </div>
          ...
          value={
            <Tooltip
              ...
              renderContent={() => {
                return (
                  <div>
                    <Trans>JLP Token pricing includes positions' Pending PnL, Impact Pool Amount and Borrow Fees.</Trans>
                  </div>
                );
              }}
            />
        ...
        <CardRow
          ...
          value={
            marketBalance && marketBalanceUsd
              ? formatTokenAmountWithUsd(marketBalance, marketBalanceUsd, "JLP", marketToken.decimals)
              : "..."
          }
        />
        ...
        <CardRow
          ...
          value={
            marketTotalSupply && marketTotalSupplyUsd
              ? formatTokenAmountWithUsd(marketTotalSupply, marketTotalSupplyUsd, "JLP", marketToken.decimals)
              : "..."
          }
        />
