...
import "./GmList.scss";
import "components/Glp/GlpSwap.css";
          ...
          {!hideTitle && (
            <>
              <div className="App-card-title">
                <Trans>JLP ({getChainName(chainId)})</Trans>
              </div>
              ...
              {marketTokens.map((token) => {
                ...
                return (
                  <tr key={token.address}>
                    ...
                    <td>
                      {formatTokenAmount(token.balance, token.decimals, "JLP")}
                      <br />
                    ...
                    <td className="GmList-last-column">
                      {formatTokenAmount(totalSupply, token.decimals, "JLP", {
                        useCommas: true,
                      })}
                      <br />
                ...
                <div className="App-card" key={token.address}>
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>
                        {" "}
                        {formatTokenAmount(totalSupply, token.decimals, "JLP")} ({formatUsd(totalSupplyUsd)})
                      </div>
                    </div>
                    <div className="App-card-divider"></div>
