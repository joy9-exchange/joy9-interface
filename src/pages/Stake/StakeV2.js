      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        ...
        {burnAmount && burnAmount.gt(0) && rewardReductionBasisPoints && rewardReductionBasisPoints.gt(0) && (
          <div className="Modal-note">
            <Trans>
              Unstaking will burn&nbsp;
              <ExternalLink className="display-inline" href="https://doc.joy9.io/general/rewards">
        ...
        <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title} className="non-scrollable">
          <div className="Exchange-swap-section">
            ...
            <div className="Exchange-swap-section-bottom">
              ...
              <div className="PositionEditor-token-symbol">esJOY9</div>
            </div>
          </div>
          <div className="VesterDepositModal-info-rows">
            <div className="Exchange-info-row">
              ...
              <div className="align-right">{formatAmount(balance, 18, 2, true)} esJOY9</div>
            </div>
            <div className="Exchange-info-row">
              <div className="Exchange-info-label">
                    ...
                    return (
                      <div>
                        ...
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Deposited`}
                          value={`${formatAmount(vestedAmount, 18, 2, true)} esJOY9`}
                        />
                        <StatsTooltipRow
                          showDollar={false}
                          label={t`Max Capacity`}
                          value={`${formatAmount(maxVestableAmount, 18, 2, true)} esJOY9`}
                        />
                      </div>
                    );
                  }}
                        ...
                        {amount && nextReserveAmount.gt(maxReserveAmount) && (
                          <>
                            ...
                            <Trans>
                              ...
                              {stakeTokenLabel} to vest {formatAmount(amount, 18, 2, true)} esJOY9.
                            </Trans>
                          </>
                        )}
                      </>
      ...
      <Modal isVisible={isVisible} setIsVisible={setIsVisible} label={title}>
        <Trans>
          <div>
            ...
            <br />
            <br />
            esJOY9 tokens that have been converted to JOY9 will remain as JOY9 tokens.
            <br />
            <br />
            To claim JOY9 tokens without withdrawing, use the "Claim" button under the Total Rewards section.
            <br />
            <br />
          </div>
        </Trans>
...
function CompoundModal(props) {
  ...
  const getPrimaryText = () => {
    if (isApproving) {
      return t`Approving JOY9...`;
    }
    if (needApproval) {
      return t`Approve JOY9`;
    }
    if (isCompounding) {
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const vesterAddresses = [gmxVesterAddress, ];
  ...
  const walletTokens = [gmxAddress, esGmxAddress, stakedGmxTrackerAddress];
  const depositTokens = [
    gmxAddress,
    esGmxAddress,
  ...
  //);
  //TODO
  const nativeTokenPrice = expandDecimals(1830, 30);
  ...
  //});
  const gmxSupply = bigNumberify(10000000000);
  ...
  console.log("depositBalanceData: ", depositBalanceData);
  ...
  */
  ...
  const showGmxVesterDepositModal = () => {
    ...
    setVesterDepositTitle(t`JOY9 Vault`);
    setVesterDepositStakeTokenLabel("staked JOY9 + esJOY9 + Multiplier Points");
  ...
  const showGmxVesterWithdrawModal = () => {
    ...
    setVesterWithdrawTitle(t`Withdraw from JOY9 Vault`);
  ...
  const showUnstakeGmxModal = () => {
    ...
    setUnstakeModalTitle(t`Unstake JOY9`);
    ...
    setUnstakeValue("");
    setUnstakingTokenSymbol("JOY9");
    setUnstakeMethodName("unstakeJoy9");
  };

  const showUnstakeEsGmxModal = () => {
    setIsUnstakeModalVisible(true);
    setUnstakeModalTitle(t`Unstake esJOY9`);
    ...
    setUnstakeModalReservedAmount(vestingData.gmxVesterPairAmount);
    setUnstakeValue("");
    setUnstakingTokenSymbol("esJOY9");
    setUnstakeMethodName("unstakeEsJoy9");
  };
        ...
        renderContent={() => {
          return (
            <Trans>
              ...
              <ExternalLink href="https://doc.joy9.io/general/rewards#multiplier-points">More info</ExternalLink>.
            </Trans>
          );
        }}
      />
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.gmxInStakedGmx && processedData.gmxInStakedGmx.gt(0)) {
      gmxAmountStr = formatAmount(processedData.gmxInStakedGmx, 18, 2, true) + " JOY9";
    }
    let esGmxAmountStr;
    if (processedData.esGmxInStakedGmx && processedData.esGmxInStakedGmx.gt(0)) {
      esGmxAmountStr = formatAmount(processedData.esGmxInStakedGmx, 18, 2, true) + " esJOY9";
    }
    let mpAmountStr;
    ...
    <div className="default-container page-layout">
      ...
      <div className="section-title-block">
        ...
        <div className="section-title-content">
          ...
          <div className="Page-description">
            <Trans>
              Stake <ExternalLink href="https://doc.joy9.io/general/tokenomics">JOY9</ExternalLink> to earn rewards.
            </Trans>
          </div>
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            <div className="App-card-title">JOY9</div>
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxBalance", 18, 2, true)} JOY9 ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} JOY9 ($
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} JOY9 ($
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxBalance", 18, 2, true)} esJOY9 ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "esGmxInStakedGmx", 18, 2, true)} esJOY9 ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "stakedEsGmxSupply", 18, 0, true)} esJOY9 ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatAmount(esGmxSupply, 18, 0, true)} esJOY9 (${formatAmount(esGmxSupplyUsd, USD_DECIMALS, 0, true)}
                  )
                </div>
              </div>
              <div className="App-card-divider"></div>
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esJOY9 tokens to JOY9 tokens.
              <br />
              Please read the{" "}
              <ExternalLink href="https://doc.joy9.io/general/rewards#vesting">vesting details</ExternalLink> before
              using the vaults.
            </Trans>
          </div>
        </div>
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                        ...
                        return (
                          <div>
                            <Trans>
                              ...
                              converted to JOY9 from the{" "}
                              {formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true)} esJOY9 deposited for
                              vesting.
                            </Trans>
                          </div>
                        );
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} JOY9`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} JOY9 tokens can be claimed,
