    ...
    if (!hasMetaMaskWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink>, and use joy9 with its built-in
              browser.
            </Trans>
          ) : (
            <Trans>
              <ExternalLink href="https://metamask.io">Install MetaMask</ExternalLink> to start using joy9.
            </Trans>
          )}
        </div>
      );
